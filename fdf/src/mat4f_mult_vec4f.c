...
** Last update Wed May 12 19:27:08 2010 antoine luciani
*/
				 ...
				 struct s_vector4f *result)
{
  ...
  result->x += mat[0][2] * v->z + mat[0][3] * v->z;
  result->y = mat[1][0] * v->x + mat[1][1] * v->y;
  result->y += mat[1][2] * v->z + mat[1][3] * v->z;
  result->z = mat[2][0] * v->x + mat[2][1] * v->y;
  result->z += mat[2][2] * v->z + mat[2][3] * v->z;
  result->w = mat[3][0] * v->x + mat[3][1] * v->y;
  result->w += mat[3][2] * v->z + mat[3][3] * v->z;
}
