...
static void	mlx_int_rgb_conversion_sub1(t_xvar *xvar)
{
...
static void	mlx_int_rgb_conversion_sub2(t_xvar *xvar)
{
  while (xvar->visual->green_mask & 1)
    {
      xvar->visual->green_mask >>= 1;
...
int	mlx_int_rgb_conversion(t_xvar *xvar)
{
  ...
  mlx_int_rgb_conversion_sub1(xvar);
  mlx_int_rgb_conversion_sub2(xvar);
}
